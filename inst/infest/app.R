  ...
  observeEvent(input$fit_glm_de, {
    ...
    if(nlevels(Group) < 2) {
      ...
      if(inherits(mod_de, "try-error") |
        ...
        output$med_de <- renderPrint({
          cat("Estimated marginal means\n")
          med_de
        })
        output$contrasts_de <- renderPrint({
          cat("Pairwise comparisons of means\n")
          comp_med_de
        })
                                   ...
                                   tabsetPanel(
                                     ...
                                     tabPanel(icon("calculator"),
                                              ...
                                              column(width = 8,
                                                     ...
                                                     conditionalPanel(condition = "input.bxp2 == FALSE",
                                   ...
                                   tabsetPanel(
                                     ...
                                     tabPanel(icon("calculator"),
                                              ...
                                              column(width = 8,
                                                     ...
                                                     conditionalPanel(condition = "input.bxp3 == FALSE",
