...
comp_l <- lapply(means_l, function(x) {
   try(pairs(x, adjust = mods[[1]]$adj), silent=TRUE)
})
...
****
<div class="logos"><img src="infest_2_0.png" width="125px" align="right"></div>

<font size="1">  Date and time: `r Sys.time()`

This document was automatically generated with [INFEST - Insect Feeding Behavior Statistics](https://arsilva87.github.io/infest/) v2.0 

Powered by [Instituto Federal Goiano](https://www.ifgoiano.edu.br/home/index.php/urutai)  <img draggable="false" role="img" class="emoji" alt="🇧🇷" src="br-flag.svg" width="17px">
